...
vowel_count = lambda s: sum(1 for i in s if i in 'аеёиоуыэюя')

def syllable_count(stih):
    return set(map(vowel_count, list(map(str, stih.split()))))

stih = 'пара-ра-рам рам-пам-папам па-ра-па-да'
if len(syllable_count(stih))>1:
    print('Пам парам')
else:
    print('Парам пам-пам')